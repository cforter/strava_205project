import stravalib,simplekml,os
from stravalib.client import Client



### Got the following polyline converter defs here: https://gist.github.com/signed0/2031157
...
#athlete = client.get_athlete(client_id)
...
for activity in client.get_activities():
    ...
    coords = decode(activity.map.summary_polyline)
    kml.newlinestring(name=activity.name, description="Strava run",
                        coords=coords)

    kml.save(os.getcwd() + "\\tmprun_"+activity.name+".kml")

##for follower in client.get_athlete_followers():
##    print follower.firstname + " " + follower.lastname
##    print follower.id
##    athlete = client.get_athlete(follower.id)
##for activity in client.get_friend_activities():
##    print activity
##    for activity in athlete.get_athlete_activities():
##        print activity
